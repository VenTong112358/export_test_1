...
export default function WordPreviewRoute() {
  ...
  console.log('[testblank] params:', params);
  console.log('[testblank] parsed logId:', logId);
  console.log('[testblank] logs available:', Array.isArray(logs) ? logs.length : 'none');
  console.log('[testblank] derived words count:', Array.isArray(words) ? words.length : 'invalid');
